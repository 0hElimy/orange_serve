...
<body>
@include('layouts.home.shared._hmtop')
<div class="shopNav">
    <div class="slideall" style="height: auto;">

        @include('layouts.home.shared._header')
                    ...
                    <div class="category" style="box-shadow:none ;margin-top: 2px;">
                        <ul class="category-list navTwo" id="js_climit_li">
                            ...
                            <li>
                                <div class="category-info">
                                    <h3 class="category-name b-category-name">
                                        <i><img src="/vendor/home/images/chocolate.png"></i><a class="ml-22" title="巧克力">巧克力</a>
                                    </h3>
                                    <em>&gt;</em></div>
                                <div class="menu-item menu-in top">
                                    <div class="area-in">
...
<div class="shopMainbg">
    <div class="shopMain" id="shopmain">
        ...
        @include('layouts.home.shared._footer')
    </div>
</div>
...
<!--菜单 -->
@include('layouts.home.shared._tip')
<script>
